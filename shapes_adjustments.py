# 28 feb 2024
# I'm using my generic boiler plate from my "really had to python" repo as starting point
# The goal is to insert the text input/output functionality from the pygame example script 
# textinput.py
